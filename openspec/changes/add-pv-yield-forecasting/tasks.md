...
- [ ] 2.1 Add backward-compatible SQLite and PostgreSQL migrations for forecast settings, immutable weather runs/points, calculation runs/results, provenance, uncertainty, invalidations, and retention metadata.
- [ ] 2.2 Implement cross-engine repositories for effective forecast configuration and immutable normalized weather runs with ordering, overlap, revision, classification, and idempotency constraints.
