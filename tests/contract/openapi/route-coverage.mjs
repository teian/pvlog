...
const required = [
  ...
  ["get", "/api/v1/account/profile", "getCurrentUserProfile"],
  ["put", "/api/v1/account/profile", "updateCurrentUserProfile"],
  ["get", "/api/v1/account/api-keys", "listAccountApiKeys"],
  ["post", "/api/v1/account/api-keys", "createAccountApiKey"],
  ["delete", "/api/v1/account/api-keys/{api_key_id}", "revokeAccountApiKey"],
  ["get", "/api/v1/systems/{id}", "getSystem"],
  ...
  ["get", "/api/v1/systems/{system_id}/overview", "getSystemOverview"],
  [
    "get",
    "/api/v1/systems/{system_id}/reporting/statistics",
    "getSystemReportingStatistics",
  ],
  [
    "get",
    "/api/v1/systems/{system_id}/seasonal",
    "getSystemSeasonalProduction",
  ],
  [
    "get",
    "/api/v1/systems/{system_id}/weather-forecast",
    "getSystemWeatherForecast",
  ],
  ["get", "/api/v1/equipment-catalog/inverters", "listCatalogInverters"],
  ["get", "/api/v1/geocoding/search", "searchAddress"],
  [
    "get",
    "/api/v1/equipment-catalog/inverters/{entry_id}",
    "getCatalogInverter",
  ],
  ["get", "/api/v1/equipment-catalog/solar-modules", "listCatalogSolarModules"],
  [
    "get",
  ...
  ["get", "/api/v1/systems/{system_id}/inverters", "listInverters"],
  ["post", "/api/v1/systems/{system_id}/inverters", "createInverter"],
  [
    "put",
